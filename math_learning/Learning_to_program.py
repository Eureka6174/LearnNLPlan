import numpy as np
from openai_public import query_azure_openai_chatgpt_complete,query_azure_openai_chatgpt_chat,multi_threading_running
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', type=str, default='1', help='(default=%(default)s)')
    parser.add_argument('--model', type=str, default='gpt-35-turbo', help='(default=%(default)s)')
    parser.add_argument('--path', type=str, default='C:\\Users\\v-yiduoguo\\pycharmprojects\\pythonproject\\api_learning_2\\khan\\', help='(default=%(default)s)')
